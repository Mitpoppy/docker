!function() {
    console.info("welcome to WebViso/yestool，author：YesTool，author url: https://webviso.yestool.org"),
    setTimeout((function() {
    ...
    let t = e.getAttribute("data-base-url")
      , o = e.getAttribute("data-page-pv-id")
      , n = e.getAttribute("data-page-uv-id");
    const r = {
        version: "0.0.0"
    };
